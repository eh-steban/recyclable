Use the service agent appropriate to the files being changed (see Agents
...
5. Self-review: check for security issues (no exposed secrets, inputs
   validated at boundaries) and convention compliance. For changes touching
   auth or data handling, also invoke the code-reviewer agent.
