...
This document defines how to capture, organize, and reference knowledge across the project. It prevents valuable discoveries from being lost and enables Claude instances to discover relevant knowledge when needed.
