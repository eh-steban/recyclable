...
from app.infra.db.repositories.jurisdiction_repo import (
    SqlJurisdictionRepository,
)
from app.infra.db.repositories.material_repo import SqlMaterialRepository
from app.infra.db.repositories.regression_case_repo import (
    SqlRegressionCaseRepository,
)
from app.infra.db.repositories.rule_repo import SqlRuleRepository
from app.infra.db.repositories.source_document_repo import (
